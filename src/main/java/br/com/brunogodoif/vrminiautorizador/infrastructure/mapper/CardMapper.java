...
public class CardMapper {
    public br.com.brunogodoif.vrminiautorizador.application.domain.entity.Card toDomainObj(Card cardEntity) {
        return new br.com.brunogodoif.vrminiautorizador.application.domain.entity.Card(
                cardEntity.getId(),
    ...
    public Card toEntity(br.com.brunogodoif.vrminiautorizador.application.domain.entity.Card card) {
